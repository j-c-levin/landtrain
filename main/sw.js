...
const CACHE_VERSION = '597197c569';
const CACHE_PREFIX = `precache-${self.registration.scope}-`;
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
const PRECACHE_FILES = ["./assets/fraunces-italic-var-lSdLDfvT.woff2","./assets/fraunces-normal-var-DihXLNYH.woff2","./assets/index-D3ItMvwr.js","./assets/index-DTUkJsKE.css","./index.html"];
